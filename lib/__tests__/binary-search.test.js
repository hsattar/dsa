...
(0, vitest_1.describe)('Linear Search', () => {
    (0, vitest_1.it)('SHOULD RETURN A BOOLEAN', () => {
        ...
        const searchValue = 5;
        const result = (0, binary_search_1.binarySearch)(input, searchValue);
    ...
    (0, vitest_1.it)('SHOULD NOT MODIFY THE ORIGINAL INPUT', () => {
        ...
        const searchValue = 5;
        (0, binary_search_1.binarySearch)(input, searchValue);
        (0, vitest_1.expect)(input).toEqual(inputCopy);
    });
    (0, vitest_1.it)('SHOULD RETURN FALSE IF IT CANT FIND THE SEARCH VALUE', () => {
        const input = [1, 2, 3, 4];
        const searchValue = 9;
    ...
    (0, vitest_1.it)('SHOULD RETURN TRUE IF IT FINDS THE SEARCH VALUE IN A SMALL ARRAY', () => {
        const input = [1, 2, 3, 4, 5];
        const searchValue = 5;
    ...
    (0, vitest_1.it)('SHOULD RETURN TRUEIF IT FINDS THE SEARCH VALUE IN A SLIGHTLY LARGER ARRAY', () => {
    ...
    (0, vitest_1.it)('SHOULD RETURN TRUE IF IT FINDS THE SEARCH VALUE IN A LARGE ARRAY', () => {
