...
(0, vitest_1.describe)('Selection Sort', () => {
    (0, vitest_1.it)('SHOULD RETURN AN ARRAY OF THE SAME LENGTH', () => {
        const input = [2, 1, 3];
        const result = (0, selection_sort_1.selectionSort)(input);
        (0, vitest_1.expect)(result.length).toBe(3);
    });
    (0, vitest_1.it)('SHOULD NOT MODIFY THE ORIGINAL INPUT', () => {
        const input = [2, 1, 3];
        const inputCopy = [2, 1, 3];
        (0, selection_sort_1.selectionSort)(input);
        (0, vitest_1.expect)(input).toEqual(inputCopy);
    });
    (0, vitest_1.it)('SHOULD RETURN A SORTED ARRAY WHEN PASSED 2 NUMBERS IN REVERSE ORDER', () => {
        const input = [2, 1];
        const expectedOutput = [1, 2];
        const result = (0, selection_sort_1.selectionSort)(input);
        (0, vitest_1.expect)(result).toEqual(expectedOutput);
    });
    (0, vitest_1.it)('SHOULD RETURN A SORTED ARRAY WHEN PASSED MULTIPLE NUMBERS IN RANDOM ORDER', () => {
        const input = [5, 9, 3, 1, 2, 8, 4, 7, 6];
        const expectedOutput = [1, 2, 3, 4, 5, 6, 7, 8, 9];
        const result = (0, selection_sort_1.selectionSort)(input);
        (0, vitest_1.expect)(result).toEqual(expectedOutput);
    });
    (0, vitest_1.it)('SHOULD RETURN A SORTED ARRAY WHEN PASSED A LARGE NUMBERS ARRAY IN RANDOM ORDER', () => {
...
//# sourceMappingURL=selection-sort.test.js.map