...
(0, vitest_1.describe)('Bubble Sort', () => {
    ...
    (0, vitest_1.it)('SHOULD NOT MODIFY THE ORIGINAL INPUT', () => {
        ...
        (0, bubble_sort_1.bubbleSort)(input);
    ...
    vitest_1.it.only('SHOULD RETURN A SORTED ARRAY WHEN PASSED MULTIPLE NUMBERS IN RANDOM ORDER', () => {
...
//# sourceMappingURL=bubble-sort.test.js.map